                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($emplois as $row) :
                                            if ($row->jour == 'lundi' && $row->heure_debut == '08:00:00') :
                                                ...
                                                echo '<div style="margin-top: 10px;">' . $row->nom_enseignant . ' ' . $row->prenom_enseignant . '</div>';
                                                echo '<a href="' . base_url("listeEmplois/update/" . $row->id) . '"><span class="badge bg-label-warning me-1"><i class="bx bxs-edit"></i></span></a>';
                                                echo '<a class="deleteBtn" href="' . base_url("listeEnseignants/sup/" . $row->id) . '"><span class="badge bg-label-danger me-1"><i class="bx bxs-trash"></i></span></a>';
                                                                                       endif;
                                        endforeach;
                                        ?>
                                    </td>
                                        ...
                                        <?php foreach($emplois as $row):
                                            if($row->jour=='mercredi' && $row->heure_debut=='08:00:00'):
                                                ...
                                                echo '<a href="' . base_url("listeEmplois/update/" . $row->id) . '"><span class="badge bg-label-warning me-1"><i class="bx bxs-edit"></i></span></a>';
                                                echo '<a class="deleteBtn" href="' . base_url("listeEnseignants/sup/" . $row->id) . '"><span class="badge bg-label-danger me-1"><i class="bx bxs-trash"></i></span></a>';
                                                                                       endif; endforeach;?>                                        </td> <td class="bg-light-gray">
                                        <?php foreach($emplois as $row):
                                    ...
                                    <tr>
                                        ...
                                        <?php foreach($emplois as $row):
                                            if($row->jour=='lundi' && $row->heure_debut=='08:00:00'):
                                                ...
                                                echo '<a href="' . base_url("listeEmplois/update/" . $row->id) . '"><span class="badge bg-label-warning me-1"><i class="bx bxs-edit"></i></span></a>';
                                                echo '<a class="deleteBtn" href="' . base_url("listeEnseignants/sup/" . $row->id) . '"><span class="badge bg-label-danger me-1"><i class="bx bxs-trash"></i></span></a>';
                                                                                       endif; endforeach;?>                                        <td class="bg-light-gray">
                                        <?php foreach($emplois as $row):
