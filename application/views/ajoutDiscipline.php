                                    ...
                                    <div class="mb-3 col-md-10">
                                        ...
                                        <select name="type" id="type" data-placeholder="-- Select Type --" class="select2 form-select">
                                            <option></option>
                                                ...
                                                <option value="Comportements inappropriés">Comportements inappropriés </option>
                                                <option value="Tricherie">Tricherie  </option>
                                                <option value="Destruction de biens scolaires">Destruction de biens scolaires  </option>
                                        </select>          
